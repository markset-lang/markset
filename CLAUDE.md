...
- `npm run typecheck` runs `tsc --noEmit`. `typescript`, `@types/node` (approved 2026-09-14) and `@biomejs/biome` (approved 2026-09-15) are the only dev dependencies; there is still no build step.
