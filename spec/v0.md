...
**HTML:** `<div class="ms-columns" data-gap="md" style="--ms-ratio: 2 1">` with `<div class="ms-column">` children. The ratio is emitted as a custom property because it is genuinely per-instance data; figure `width` (§4.8) is the only other place a style attribute appears.
